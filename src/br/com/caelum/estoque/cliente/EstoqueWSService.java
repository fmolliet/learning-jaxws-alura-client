 ...
 * 
 */
@WebServiceClient(name = "EstoqueWSService", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8080/estoquews?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ESTOQUEWSSERVICE_QNAME = new QName("http://ws/", "EstoqueWSService");
    ...
    public EstoqueWS getEstoqueWSPort() {
        return super.getPort(new QName("http://ws/", "EstoqueWSPort"), EstoqueWS.class);
    }
    ...
    public EstoqueWS getEstoqueWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws/", "EstoqueWSPort"), EstoqueWS.class, features);
    }
